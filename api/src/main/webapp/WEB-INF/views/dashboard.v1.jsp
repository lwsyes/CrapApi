...
<head>
    ...
    <link href="resources/css/base.css?v=V8.2.0_0631" rel="stylesheet" type="text/css"/>
    <link href="resources/css/crapApi.css?v=V8.2.0_0631" rel="stylesheet" type="text/css"/>
    <link href="resources/css/setting.css?v=V8.2.0_0631" rel="stylesheet" type="text/css"/>
    <title>${title}</title>
</head>
<body class="BGFFF">
<!-- top navbar -->
...
<script src="https://api-crap-cn.oss-cn-beijing.aliyuncs.com/api.crap.cn/jquery-1.9.1.min.js"></script>
<script src="resources/js/core.js?v=V8.2.0_0631"></script>
<script src="resources/js/crapApi.js?v=V8.2.0_0631"></script>
</body>
</html>
